...
const UpdateEmployee = () => {
  ...
  const updateEmployee = (e) => {
    e.preventDefault();
    EmployeeService.updateEmployeeById(id, employee).then(response => navigate("/employeeList")).catch(error => console.log(error))
  };
      ...
      <div className="px-8 py-8">
        ...
        <div className="flex items-center justify-center h-14 w-full my-4 space-x-4 py-">
          ...
          >
            ...
            <button onClick= {() => navigate("/employeeList")}className="rounded text-white font-semibold bg-red-400 py-2 px-6 hover:bg-red-600">
              Cancel
            </button>
        </div>
      </div>
